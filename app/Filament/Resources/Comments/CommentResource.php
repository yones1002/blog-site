...
class CommentResource extends Resource
{
    ...
    protected static ?string $modelLabel = 'کامنت';
    protected static ?string $pluralModelLabel = 'کامنت ها';

    protected static ?string $recordTitleAttribute = 'کامنت ها';
    ...
    {
        return CommentsTable::configure($table)->modifyQueryUsing(fn ($query) => $query->with('commentable'));
    }
