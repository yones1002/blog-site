            ...
            <div class="bl-2">
                ...
                <div class="bc-5">
                    <div class="bc-6">
                        <div class="bc-7">📄</div>
                        <div>
                            <div class="bc-9">{{ $categories->total() ?? 0 }}</div>
                    ...
                    <div class="bc-6">
                        ...
                        <div>
                            <div class="bc-9">{{ $totalBlogs ?? 0 }}</div>
            ...
            <div class="bc-22">
                    ...
                    <article class="bc-23" style="animation-delay: {{ $index * 0.08 }}s">
                        ...
                        <div class="bc-24">
                            <div class="bc-24-icon">
                                {{ $category->icon ?? mb_substr($category->fa_name ?? '؟', 0, 1) }}
                            </div>
                        ...
                        <div class="bc-27">
                            ...
                            <div class="bc-28">
                                <span class="bc-28-badge">📌 {{ $category->blogs_count ?? 0 }} مقاله</span>

                                @if(($category->blogs_count ?? 0) > 10)
                            ...
                            <p class="bc-32">
                                {{ $category->description ?? ('مقالات مرتبط با ' . ($category->fa_name ?? 'موجود نیست')) }}
                            </p>
                            ...
                            <div class="bc-33">
                                ...
                                <span class="bc-36">
                                    <span class="bc-37">
                                        آخرین: {{ optional($category->updated_at)->diffForHumans() ?? '—' }}
                                    </span>
                                </span>
                            </div>
                ...
                @empty
                    <div class="bc-38">
                        ...
                        <a target="_self" href="{{ url()->current() }}" class="bc-41-btn">
                            پاک کردن فیلتر
                        </a>
                    </div>
                @endforelse
                        ...
                        @foreach($categories->sortByDesc('blogs_count')->take(5) as $cat)
                            <a target="_self"
                               ...
                               class="bc-52">
                                ...
                                <span class="bc-52-name">
                                    {{ $cat->fa_name ?? 'موجود نیست' }}
                                </span>
                    ...
                    <div class="bc-51 bc-51-tags">
                        @foreach($tags as $tag)
                            <a target="_self" href="" class="bc-52-tag">
                                <span>{{ $tag->fa_name ?? 'موجود نیست' }}</span>
                            </a>
                        @endforeach
                    </div>
                </div>
                ...
                <div class="bc-49">
                    ...
                    <div class="bc-55">
                        @foreach($topAuthors as $author)
                            <a target="_self" href="/authors/{{ $author->id ?? 0 }}" class="bc-56">

                                <div class="bc-57">
                                    @php
                                        $first = mb_substr($author->name ?? 'N', 0, 1);
                                        $avatar = $author->avatar
                                            ?? 'https://placehold.co/100x100/333/fff?text=' . urlencode($first);
                                    @endphp
                                ...
                                <div class="bc-59">
                                    <div class="bc-60">{{ $author->name ?? 'موجود نیست' }}</div>
                                    <div class="bc-61">{{ $author->blogs_count ?? 0 }} مقاله</div>
                                </div>
