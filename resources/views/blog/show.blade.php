...
@section('content')
    ...
    <link href="{{ asset('css/front/show-blog.css') }}" rel="stylesheet">
    ...
    <section class="bl-1">
        <div class="bl-2">
            <nav class="bl-3">
                ...
                <a href="/blog" class="bl-4">مجله</a>
                <span class="bl-5">/</span>
                <span class="bl-6">{{$blog->category->fa_name}}</span>
            </nav>
    ...
    <section class="bs-9">
        ...
        <article class="bs-10">
            ...
            <div class="bs-17">
                ...
                <div class="bs-18">
                    <a href="https://twitter.com/share?url={{url()->current()}}" target="_blank" class="bs-19">
                    ...
                    <a href="https://t.me/share/url?url={{url()->current()}}" target="_blank" class="bs-19">
                    ...
                    <a href="https://wa.me/?text={{url()->current()}}" target="_blank" class="bs-19">
...
{{--                @endforeach--}}
            ...
            <div class="bs-50">
                ...
                <div class="bs-51">
                    @foreach($relatedBlogs as $related)
                        <a href="/blog/{{$related->slug}}" class="bs-52">
                            <div class="bs-53">
    ...
    <section class="bs-60">
        <div class="bs-61">
            @if($prevBlog)
                <a href="/blog/{{$prevBlog->type}}/{{$prevBlog->slug}}" class="bs-62">
            ...
            @if($nextBlog)
                <a href="/blog/{{$prevBlog->type}}/{{$nextBlog->slug}}" class="bs-62">
