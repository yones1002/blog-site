    ...
    <section class="bs-9">
        ...
        <article class="bs-10">
            ...
            <div class="bs-17">
                ...
                <div class="bs-18">
                    <a target="_self" href="https://twitter.com/share?url={{url()->current()}}" target="_blank" class="bs-19">
                    ...
                    <a target="_self" href="https://t.me/share/url?url={{url()->current()}}" target="_blank" class="bs-19">
                    ...
                    <a target="_self" href="https://wa.me/?text={{url()->current()}}" target="_blank" class="bs-19">
